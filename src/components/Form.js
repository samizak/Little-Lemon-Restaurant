...
function Form() {
  ...
  return (
    <form onSubmit={handleSubmit(formSubmit)}>
      <fieldset>
        <div data-testid="full-name-div" className="field">
          <label htmlFor="name">Full Name</label>
          <input data-testid="full-name-input" type="text" placeholder="John Doe" name="name" {...register("name")} />
          <span data-testid="full-name-error" className="error-message">
            {errors.name?.message}
          </span>
        </div>
        <div className="field">
        ...
        <div className="field">
          ...
          <span data-testid="telephone-error" className="error-message">
        ...
        <button data-testid="submit-button" className="reserve-btn" type="submit">
          Reserve
        </button>
      </fieldset>
    </form>
